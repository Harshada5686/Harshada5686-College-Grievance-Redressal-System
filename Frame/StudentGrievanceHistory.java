...
public class StudentGrievanceHistory extends javax.swing.JFrame {

   
    public StudentGrievanceHistory() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("STUDENT GRIEVANCE HISTORY");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "URN", "Grievance id", "Date", "Subject", "Description"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentGrievanceHistory().setVisible(true);
            }
        });
    }
