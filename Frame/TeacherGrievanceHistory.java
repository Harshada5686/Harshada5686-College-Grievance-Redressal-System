...
public class TeacherGrievanceHistory extends javax.swing.JFrame {

   
    public TeacherGrievanceHistory() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("TEACHER GRIEVANCE HISTORY");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "URN", "Grievance id", "Date", "Subject", "Description", "Status", "Reply"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TeacherGrievanceHistory().setVisible(true);
            }
        });
    }
